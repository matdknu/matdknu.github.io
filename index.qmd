...
<div class="site-column home-page">
  ...
  <div data-lang="en" class="lang-pane">
    <section class="home-hero">
      <div class="home-hero__main">
        <p class="home-eyebrow">Santiago, Chile — PhD candidate track</p>
        ...
        <div class="home-tags">
          <span class="home-tag">Computational Social Science</span>
          <span class="home-tag">Survey Methods</span>
          <span class="home-tag">NLP</span>
          <span class="home-tag">Democracy</span>
          <span class="home-tag">Innovation</span>
        </div>
      ...
      <aside class="home-hero__aside">
        ...
        <p class="home-photo-caption">CIIR · OLES · MethodoLab</p>
      </aside>
    </section>
    ...
    <section class="home-about">
      <div class="home-about__col">
        ...
        <p>Matías Deneken is a Chilean sociologist and data scientist whose work sits at the intersection of the sociology of violence, democracy, and computational social science. His research examines how social processes unfold in contemporary societies through the rigorous application of quantitative and computational methods. He has contributed to major large-scale longitudinal projects, including the <em>Estudio Longitudinal de Relaciones Interculturales (ELRI)</em> and the <em>Estudio Panel de Percepciones de Seguridad y Policías (EPSEP)</em>.</p>

        <h2 class="section-heading">Now</h2>
        <p>Today, Matías is fully committed to building <strong><a href="https://www.methodolab.com" target="_blank" rel="noopener noreferrer">MethodoLab</a></strong> — a data science initiative he founded to push the frontier of computational methods in social research. He is also actively pursuing doctoral study opportunities <em>(exciting news coming soon)</em>.</p>
    ...
    <section class="home-agenda-cta">
      <p class="home-agenda-cta__text"><strong>Current agenda</strong> — literature reviews, methods notes &amp; upcoming posts</p>
  ...
  <div data-lang="es" class="lang-pane is-lang-hidden">
    <section class="home-hero">
      <div class="home-hero__main">
        <p class="home-eyebrow">Santiago, Chile — candidatura doctoral</p>
        <h1 class="home-name">Matías<br>Deneken</h1>
        <p class="home-tagline">Sociólogo y científico de datos. Ciencia social computacional, democracia y violencia política.</p>
        <div class="home-tags">
          <span class="home-tag">Ciencia Social Computacional</span>
          <span class="home-tag">Métodos de encuesta</span>
          <span class="home-tag">NLP</span>
          <span class="home-tag">Democracia</span>
          <span class="home-tag">Innovación</span>
        </div>
    ...
    <section class="home-about">
      <div class="home-about__col">
        ...
        <p>Matías Deneken es un sociólogo y científico de datos chileno cuyo trabajo se sitúa en la intersección de la sociología de la violencia, la democracia y la ciencia de datos computacional. Ha colaborado en estudios longitudinales a gran escala como el <em>Estudio Longitudinal de Relaciones Interculturales (ELRI)</em> y el <em>Estudio Panel de Percepciones de Seguridad y Policías (EPSEP)</em>.</p>

        <h2 class="section-heading">Ahora</h2>
        <p>Actualmente está plenamente comprometido con <strong><a href="https://www.methodolab.com" target="_blank" rel="noopener noreferrer">MethodoLab</a></strong> — iniciativa de ciencia de datos que fundó para avanzar métodos computacionales en investigación social. También busca oportunidades de estudio doctoral <em>(próximamente novedades)</em>.</p>
    ...
    <section class="home-agenda-cta">
      <p class="home-agenda-cta__text"><strong>Agenda actual</strong> — revisiones de literatura, notas de métodos y próximos posts</p>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  home.querySelectorAll(".page-columns, .page-full, .column-page").forEach(function (el) {
