      ...
      <section class="home-lower">
        ...
        <section class="home-recent">
          ...
          <ul class="home-card-grid">
            <li>
              <a class="home-card" href="https://www.crimrxiv.com/pub/3rl51qxc/release/1" target="_blank" rel="noopener noreferrer">
                <div class="home-card__media">
                  <img src="files/images/photos/chapultepec-cdmx.JPG" alt="">
                </div>
                <div class="home-card__body">
                  <span class="home-card__type">Preprint</span>
                  <p class="home-card__title">Fear of the police and the fragility of legitimacy</p>
                  <p class="home-card__meta">Deneken &amp; Díaz</p>
                  <p class="home-card__venue">CrimRxiv</p>
                </div>
              </a>
            </li>
            <li>
