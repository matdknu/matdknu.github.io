...
<div class="photography-shell">
  ...
  <section class="photography-body">
    <div class="photo-gallery photo-gallery--collage" id="photo-gallery">

      <button type="button" class="photo-card photo-card--hero"
        ...
        <img src="files/images/photos/museo_yugslavia.JPG" alt="Museum of Yugoslavia, Belgrade" loading="lazy">
        <span class="photo-card__caption">Museum of Yugoslavia</span>
      </button>

      <button type="button" class="photo-card photo-card--tall"
      ...
      <button type="button" class="photo-card photo-card--md"
      ...
      <button type="button" class="photo-card photo-card--wide"
        data-full="files/images/photos/flamencos_atacama.JPG"
        data-caption-en="Flamingos, Atacama"
        data-caption-es="Flamencos, Atacama">
        <img src="files/images/photos/flamencos_atacama.JPG" alt="Flamingos, Atacama" loading="lazy">
        <span class="photo-card__caption">Flamingos · Atacama</span>
      </button>

      <button type="button" class="photo-card photo-card--sm"
      ...
      <button type="button" class="photo-card photo-card--md photo-card--tilt-r"
      ...
      <button type="button" class="photo-card photo-card--tall photo-card--tilt-l"
      ...
      <button type="button" class="photo-card photo-card--wide"
        ...
        <img src="files/images/photos/amsterdam.JPG" alt="Amsterdam" loading="lazy">
        <span class="photo-card__caption">Amsterdam</span>
      </button>

      <button type="button" class="photo-card photo-card--sm photo-card--tilt-r"
      ...
      <button type="button" class="photo-card photo-card--md"
        ...
        <img src="files/images/photos/chapultepec-cdmx.JPG" alt="Chapultepec, Mexico City" loading="lazy">
        <span class="photo-card__caption">Chapultepec</span>
      </button>

      <button type="button" class="photo-card photo-card--wide photo-card--tilt-l"
        data-full="files/images/photos/buenos-aires.JPG"
        data-caption-en="Buenos Aires"
        data-caption-es="Buenos Aires">
        <img src="files/images/photos/buenos-aires.JPG" alt="Buenos Aires" loading="lazy">
